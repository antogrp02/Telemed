    ...
    <body>
        ...
        <script>
            document.addEventListener("DOMContentLoaded", function () {
                ...
                // Trova tutti i date picker del rinvio
                const dateInputs = document.querySelectorAll('.reschedule-form input[type="date"]');

                dateInputs.forEach(input => {
                    input.min = minDate;
                });

                console.log("[DoctorAppointments] Date min impostate correttamente a:", minDate);
            });
        </script>
